...
public class SetCodingAnnotationStudy extends CodingAnnotationStudy {
    ...
    /**
     * Returns an array of not empty or null annotations for a given set of category strings. If a category string of
     * annotator A is <b>null</b> or empty, it is replaced with the string "{idx(A)}\<null\>".
     *
