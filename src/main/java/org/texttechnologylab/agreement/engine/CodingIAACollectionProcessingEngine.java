 ...
 * <p/>
 * Creates one {@link CodingAnnotationStudy CodingAnnotationStudy} in total for which the given agreement measure is
 * computed.U
 * <p/>
 *
...
public class CodingIAACollectionProcessingEngine extends AbstractIAAEngine {
    ...
    /**
     * Parameter for the {@link SetSelectionStrategy SetSelectionStrategy} to use.<br> Default: {@link
     * SetSelectionStrategy#MAX}.<br> Choices: <ul>
    ...
    /**
     * Create per-token {@link Agreement} annotations in the given CAS.<br> The annotations will be added to a view with
     * the name "IAA". If the view does not exist, it will be created.
     * <p/>
     * <b>IMPORTANT:</b>
    ...
    /**
     * Paramter string for {@link CodingIAACollectionProcessingEngine#COHEN_KAPPA_AGREEMENT}.
     *
     * @see CohenKappaAgreement
     */
    public final static String COHEN_KAPPA_AGREEMENT = "CohenKappaAgreement";

    /**
     * Paramter string for {@link CodingIAACollectionProcessingEngine#FLEISS_KAPPA_AGREEMENT}.
     *
     * @see FleissKappaAgreement
     */
    public final static String FLEISS_KAPPA_AGREEMENT = "FleissKappaAgreement";

    /**
     * Paramter string for {@link CodingIAACollectionProcessingEngine#PERCENTAGE_AGREEMENT}.
     *
     * @see PercentageAgreement
     */
    public final static String PERCENTAGE_AGREEMENT = "PercentageAgreement";

    /**
     * Paramter string for {@link CodingIAACollectionProcessingEngine#KRIPPENDORFF_ALPHA_AGREEMENT}.
     *
     * @see KrippendorffAlphaAgreement
     */
    public final static String KRIPPENDORFF_ALPHA_AGREEMENT = "KrippendorffAlphaAgreement";

    /**
     * Parameter for the agreement measure the to use.<br> Default: {@link CodingIAACollectionProcessingEngine#KRIPPENDORFF_ALPHA_AGREEMENT
     * CodingInterAnnotatorAgreementEngine.KrippendorffAlphaAgreement}.<br> Choices:
     * <ul>
     * <li>{@link CodingIAACollectionProcessingEngine#KRIPPENDORFF_ALPHA_AGREEMENT CodingInterAnnotatorAgreementEngine.KrippendorffAlphaAgreement}
     * <li>{@link CodingIAACollectionProcessingEngine#FLEISS_KAPPA_AGREEMENT CodingInterAnnotatorAgreementEngine.FleissKappaAgreement}
     * <li>{@link CodingIAACollectionProcessingEngine#COHEN_KAPPA_AGREEMENT CodingInterAnnotatorAgreementEngine.CohenKappaAgreement}
     * <li>{@link CodingIAACollectionProcessingEngine#PERCENTAGE_AGREEMENT CodingInterAnnotatorAgreementEngine.PercentageAgreement}
     * </ul>
     * <p>
     *
    ...
    @ConfigurationParameter(
            ...
            defaultValue = KRIPPENDORFF_ALPHA_AGREEMENT,
    ...
    public void initialize(UimaContext context) throws ResourceInitializationException {
        ...
        if (pAnnotateToken && !(ImmutableSet.of(KRIPPENDORFF_ALPHA_AGREEMENT, PERCENTAGE_AGREEMENT).contains(pAgreementMeasure))) {
    ...
    public void process(JCas jCas) throws AnalysisEngineProcessException {
        try {
            ...
            perCasStudies.put(maxCasIndex, perViewAnnotationMap); // TODO: Refactor this with the token count into an object?
            ...
            getLogger().error("Error in CodingIAACollectionProcessingEngine.process().", e);
        }
    }

    /**
     * Create a global study from all items if {@link CodingIAACollectionProcessingEngine#PARAM_MULTI_CAS_HANDLING
     * PARAM_MULTI_CAS_HANDLING} is either BOTH or COMBINED.
     */
    @Override
    ...
    private void createAgreementAnnotations(JCas jCas, JCas viewIAA, LinkedHashMap<Integer, ICodingAnnotationItem[]> tokenItemLookup, IAgreementMeasure agreement, CountMap<String> globalCategoryCount) {
        try {
            ...
            getLogger().error("Could not create agreement annotations.", e);
        }
    }
    ...
    IAgreementMeasure calcualteAgreement(SetCodingAnnotationStudy codingAnnotationStudy, CountMap<String> globalCategoryCount, HashMap<String, CountMap<String>> annotatorCategoryCount, CountMap<String> globalCategoryOverlap) {
        ...
        switch (pAgreementMeasure) {
            ...
            case PERCENTAGE_AGREEMENT:
                ...
                break;
            case KRIPPENDORFF_ALPHA_AGREEMENT:
            default:
